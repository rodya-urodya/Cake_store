...
{
    private static string AppTitle = "Cake store";
    ...
    public static IServiceCollection AddAppSwagger(this IServiceCollection services, MainSettings mainSettings, SwaggerSettings swaggerSettings, IdentitySettings identitySettings)
    {
